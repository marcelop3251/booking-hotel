...
class FindAllRequestServices(
    ...
    suspend fun execute(customerId: Int, serviceType: ServiceType): Flow<RequestService> {
        return requestServiceRepository
            .findAllRequestServiceByCustomerAndBookingAndStatus(customerId, StatusBooking.CHECK_IN_APPROVED, serviceType)
    }
}