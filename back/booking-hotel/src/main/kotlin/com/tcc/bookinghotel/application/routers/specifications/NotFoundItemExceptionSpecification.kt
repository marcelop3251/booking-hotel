...
@Component
class NotFoundItemExceptionSpecification : TemplateHandlerSpecification(), ExceptionHandlerSpecification {

    override suspend fun isTypeException(e: BaseException): Boolean = e is NotFoundItemException
    ...
    override fun type(): TypeException = TypeException.ROOM_NOT_FOUND
